...
function ThinkingIndicator() {
  ...
  return (
    <div
      className={`transition-all duration-300 ease-out ${exiting ? "opacity-0 translate-y-[-4px]" : "opacity-100 translate-y-0"
        }`}
    >
        ...
        <div className="pl-9">
          ...
          <div className="mt-3 flex items-center gap-1.5">
            {STAGES.map((_, i) => (
              <div
                key={i}
                className={`h-[3px] rounded-full transition-all duration-500 ease-out ${i <= stage
